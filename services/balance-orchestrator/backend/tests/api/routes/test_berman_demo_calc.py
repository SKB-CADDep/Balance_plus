...
def dummy_thermal_calculation(pressure: float, temperature: float, flow_rate: float):
    ...
    return {"efficiency": efficiency, "power_output": power}
...
tests = [
    {
        ...
        "input": {"pressure": 4.5, "temperature": 120.0, "flow_rate": 500},
        "expected": {
            "efficiency": 0.85,
    ...
    {
        "id": "mode_2_zero_flow",
        "input": {"pressure": 4.5, "temperature": 120.0, "flow_rate": 0},
        "expected": {"efficiency": 0.0, "power_output": 0.0},
    },
    {
        "id": "mode_3_intentional_error",
        # 🔥 СПЕЦИАЛЬНО ЛОМАЕМ ТЕСТ, чтобы проверить сохранение лог-файла!
        "input": {"pressure": 5.0, "temperature": 100.0, "flow_rate": 500},
        "expected": {
            "efficiency": 0.85,
