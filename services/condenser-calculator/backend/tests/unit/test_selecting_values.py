...
class TestSolvers:
    ...
    def test_analytical_solver(self) -> None:
    ...
    def test_newton_solver_convergence(self) -> None:
    ...
    def test_bisection_solver_convergence(self) -> None:
    ...
    def test_newton_fails_to_converge(self) -> None:
    ...
    def test_bisection_fails_bad_initial_range(self) -> None:
