...
class TestVKUStrategy:
    ...
    def test_calculation_on_grid_point(self) -> None:
    ...
    def test_default_temperature(self) -> None:
        ...
        params = {"mass_flow_flow_path_1": 1250.0, "degree_dryness_flow_path_1": 0.92}
    ...
    def test_missing_required_param(self) -> None:
        ...
        params = {"degree_dryness_flow_path_1": 0.92, "temperature_air": 20.0}
